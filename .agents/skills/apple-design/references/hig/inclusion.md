...
Replace colloquial expressions with plain language. Colloquial expressions are often culture-specific and can be difficult to translate. Worse, some colloquial phrases have exclusionary meanings you might not know. Even when a colloquial phrase doesn't have an exclusionary meaning, it can still exclude everyone who doesn't understand it.

Consider carefully before including humor. Humor is highly subjective and — similar to colloquial expressions — difficult to translate from one culture to another. Including humor in your experience risks confusing people who don't understand it, irritating people who tire of repeatedly encountering it, and insulting people who interpret it differently.

## Being approachable

An approachable app or game doesn't require people to have particular skills or knowledge before they can use it, and it gives people a clear path toward deepening their understanding over time.

Present a clear, straightforward interface. To help you design a simple interface that fits in with other experiences on each platform, consider each platform's design guidelines.

Build in ways to learn how to use your app or game. Consider designing an onboarding flow that helps people who are new to your experience take a step-by-step approach while letting others skip straight to the content they want.
...
If you need to depict a generic person or people, use a nongendered human image to reinforce the message that generic person means human, not man or woman. System icon sets provide many nongendered glyphs you can use.
...
Although the assumption made in the account-access app might seem like an obvious mistake, it's important to realize that not all assumptions are so easy to spot. For example, consider an app or game that requires people to choose security questions they can answer for future identity confirmation. Using a context-specific experience to communicate something is useless for everyone who doesn't share that context and effectively excludes them. To create alternatives, you might reference more universal human experiences.
...
An inclusive app or game is accessible to everyone. People rely on system accessibility features — such as screen readers, display accommodations, closed captioning, and control customization — to customize their devices for their individual needs, so it's essential to support these features.
...
Take a people-first approach when writing about people with disabilities. For example, you could describe an individual's accomplishments and goals before mentioning a disability they may have. If you're writing about a specific person or community, find out how they self-identify.
...
To learn more about making your app or game accessible, see your framework's accessibility documentation.
...
Creating an inclusive experience can also help you prepare for localization. For example, using plain language, avoiding unnecessary gender references, representing a variety of people, and avoiding stereotypes and culture-specific content, can put you in a good position to create versions of your software localized into more languages. Using system icon sets for the glyphs in your app or game can also help streamline localization. In addition to providing many language-specific glyphs, system icon sets include glyphs you can use in both left-to-right and right-to-left contexts.
...
Writing inclusively, Accessibility
